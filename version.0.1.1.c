...
typedef struct{
    pos centre;
    int length;
    int width; // in fact length and width are half of the real length and width
    pos* door_1;
    pos* door_2;
}Room;
typedef struct{
...
FILE * fptr;
FILE * topten;
char map[Rows-bRow][Cols-bCol];
char show[Rows-bRow][Cols-bCol];
...
int generate_random(int begin,int end){
    srand(time(NULL));
    int res=rand();
    res=res%(end-begin);
    res += begin;
...
void make_map(Game * g){
    ...
    Room R_1,R_2,R_3,R_4,R_5,R_6,R_7,R_8;
    R_1.centre.x=generate_random(7,13); R_1.centre.y=generate_random(7,26);
    R_2.centre.x=generate_random(27,33); R_2.centre.y=generate_random(7,26);
    R_3.centre.x=generate_random(7,13); R_3.centre.y=generate_random(42,61);
    R_4.centre.x=generate_random(27,33); R_4.centre.y=generate_random(42,61);
    R_5.centre.x=generate_random(7,13); R_5.centre.y=generate_random(77,96);
    R_6.centre.x=generate_random(27,33); R_6.centre.y=generate_random(77,96);


}
//int make_room(Game *g,Room* R){
//
//}
